...
PROJECT_DIR = "/home/sharma/Projects/gcbfplus"
...
for frame in range(
    ...
    camera_position = Vector((
        ...
        center.y - 17.0,  # follow only along corridor
        10.0  # fixed camera height
    ))
